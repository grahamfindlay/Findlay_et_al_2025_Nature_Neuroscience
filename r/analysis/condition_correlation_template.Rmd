...
params:
  ...
  x_variable: "Total Hippocampal Theta:Delta"
  y_condition: "Early REC NREM"
  y_variable: "Cortical SWA"
title: "`r params$y_condition` `r params$y_variable` vs. `r params$x_condition` `r params$x_variable` (`r params$figure`)"
---
\pagenumbering{gobble}
```{r, include=FALSE, eval=FALSE} 
# For debugging only. Will not run when knit. 
params <- list()
params$figure <- "Fig. 2G"
params$x_condition <- "EXT Wake"
params$x_variable <- "Total Hippocampal Theta:Delta"
...
result <- sh$test_condition_correlation(
  params$x_condition, params$x_variable,
  params$y_condition, params$y_variable
)
